...
### Project Description
The primary task of this project was to modify existing code so that the new implementation makes use of modern C++ dynamic memory allocation techniques, including smart pointers, the rule of 5, and move semantics. The original code used raw pointers.
